...
int main(void)
{
  ...
  HAL_I2S_Transmit_DMA(&hi2s3, (uint16_t *)dataI2S, 100);
   ...
   // Jingle Bells
  int melody[] = {
		  E5, E5, E5, E5, E5, G5, C5, D5, E5, E5, E5, E5, F5, F5, F5,
		  E5, E5, E5, G5, G5, F5, D5, C5, C5, G5,
		  E5, E5, E5, G5, C5, D5, E5, F5, F5, F5, F5, F5,
		  E5, E5, E5, G5, G5, F5, D5, C5, C5
  };
  ...
  while (1)
  {
	  for(int i = 0; i < sizeof(melody)/sizeof(melody[0]); i++){
		  soundToneType note = melody[i];
		  CS43L22_Beep(note, 350);
	  }
